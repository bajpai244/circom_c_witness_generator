...
Fr_mul(&expaux[2],&signalValues[mySignalStart + 1],&signalValues[mySignalStart + 2]); // line circom 9
Fr_eq(&expaux[0],&signalValues[mySignalStart + 0],&expaux[2]); // line circom 9
